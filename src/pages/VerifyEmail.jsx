        ...
        {!loading && error && (
          <>
            ...
            <button
              ...
              className="mt-4 w-full bg-indigo-600 text-white py-2.5 px-4 rounded-lg hover:bg-indigo-700 transition text-base font-medium shadow-sm shadow-indigo-100"
            >
